...
from networks.yolov8 import (AUTOINSTALL, ROOT, USER_CONFIG_DIR, TryExcept, colorstr, downloads, emojis,
                                    is_colab)
...
def check_imshow(warn=False):
    ...
    from networks.yolov8 import is_docker, is_jupyter
...
def check_yolo(verbose=True):
    from networks.yolov8.torch_utils import select_device
